...
const Component1 = () => {
	const code: codeState = {
		element: () => (
			<div className="badge_component2_content">
				<div className="badge_box">99+</div>
				<button>评价</button>
			</div>
		),
  ...
  <div class="${className.replace(".", "")}_box">99+</div>
  <button>评价</button>
</div>`,
		CSSCode: (
			className: string,
...
`;
  ...
  <div className="${className.replace(".", "")}_box">99+</div>
  <button>评价</button>
</div>`,
		ReactJSCode: () => `暂无`,
		TSCode: () => `暂无`,
	...
	return (
		<>
			<div className="compontent_title" id="badge-anchor2">
				带文字标记
			</div>
			...
			<div className="component_box">
				<div className="compontent_box_content">
					<div className="badge_component2_content badge_component2_content_color">
						<div className="badge_box">99+</div>
						<button>评价</button>
					</div>
				</div>
